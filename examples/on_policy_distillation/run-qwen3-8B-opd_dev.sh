...
TEACHER_MODEL_PATH="/jpfs/shenzhennan.1/models/Qwen3-32B"
TEACHER_MODEL_NAME=${TEACHER_MODEL_PATH##*/}
TEACHER_IP="127.0.0.1" # Use localhost here, you can change it to your IP
TEACHER_PORT=13141
SGL_LOG_DIR="/jpfs-5p/shenzhennan/slime/logs/sglang/"
mkdir -p $SGL_LOG_DIR
SGL_LOG_FILE="$SGL_LOG_DIR/sglang_${TEACHER_MODEL_NAME}_${TIME}.log"

# kill the old sglang server
pkill -f sglang
sleep 3
